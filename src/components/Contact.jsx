        ...
        <div className='min-h-screen flex  flex-col items-center justify-center  md:mx-32 mx-5 mt-10'>
            <div className='flex flex-col lg:flex-row justify-between w-full'>
                <form className='w-full lg:w-2/5 space-y-5 bg-[#f2f2f2] p-5 rounded-xl'>
                    ...
                    <div className='flex flex-col'>
                        <label htmlFor='userName'>Message </label>
                         <textarea className="py-3 px-2 rounded-lg hover:shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all"
                         name="userMessage"
                          id="userMessage"
                           cols="30" 
                           rows="3">
             ...
             <div className='flex flex-col items-center w-full lg:w-2/4 my-5'>
              ...
              <p className="text-center text-sm pt-4 text-[#898888]">We'd love to hear from you! whether you have questions.feedback, or
