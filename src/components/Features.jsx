            ...
            <div className='w-full lg:w-2/4 space-y-10'>
                <div className='flex flex-row gap-5'>
                    ...
                    <div className='space-y-3'>
                        <h1 className='font-semibold text-xl'>Friendly Services</h1>
                ...
                <div className='flex flex-row gap-5'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='text-[#898888]'>we will provide excellent and Unforgettable experience for the sake of our
                            customers. </p>
                    </div>
                </div>
                <div className='flex flex-row gap-5'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='text-[#898888]'>we will provide excellent and  Affordable prices for the sake of our
                            customers. </p>
                    </div>
                </div>
            </div>
