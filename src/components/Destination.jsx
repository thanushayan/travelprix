        ...
        <div className='min-h-screen flex flex-col justify-center md:mx-32 mx-5'>
            ...
            <div className='flex flex-col lg:flex-row gap-5 mt-14'>
                <DestinationCard
                    img={img1}
                    title="paris,France"
                    para="Paris offers iconic landmarks like the Eiffel 
            Tower and world-class art at the Louvre Museum."/>


                <DestinationCard
                    img={img2}
                    title="Dubai,UAE"
                    para=" A city of superlative,Dubai boasts skyscrapers, luxury shoppping,
   and desert adventures"/>

                <DestinationCard
                    img={img3}
                    title="Venice,Italy"
                    para="Explore the romantic canals and historic arhitecture of
